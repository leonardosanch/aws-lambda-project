...
#3- docker tag dependencies-project:latest public.ecr.aws//name_docker

#4- docker push public.ecr.aws//name_docker

#Ejecutar en local:

sam local start-api --invoke-image public.ecr.aws//name_docker
...
docker tag name_docker:latest public.ecr.aws//name_docker:latest
Ejecute el siguiente comando para enviar esta imagen al repositorio de AWS recién creado:

docker push public.ecr.aws//name_docker:latest
